...
.controller('userCont', function($rootScope, $cookieStore, $scope, $http, Page,$location) {
	...
	$scope.login = function () {
		...
		if(dataObj.email=="dangvinhsieu.a10@gmail.com" && dataObj.pass=="1")
		{
			$rootScope.account="SD";
			$location.path('/home');
		}
